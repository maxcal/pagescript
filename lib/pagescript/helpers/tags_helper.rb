module Pagescript
  module TagsHelper
    ...
    # @param [Boolean] params_as_metadata
    #   Includes params as data attributes with the prefix `param-`.
    # @yield
    # @since 0.1.0
    # @api
    ...
    def params_from_url
      {}.tap do |h|
        h.merge! self.request.path_parameters
        h.merge! self.request.query_parameters
